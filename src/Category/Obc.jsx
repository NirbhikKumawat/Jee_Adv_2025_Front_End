...
export default function Obc() {
    ...
    const obcFetch = useCallback(async () => {
        setLoading(true);
        setError('');
        setResults([]);
        ...
        const requestUrl = `${API_URL}/category/obc?${queryString}`;
        try{
            ...
            console.error("Failed to fetch OBC  data");
        }finally{
            setLoading(false);
        }
    ...
    return (
        <div className="Obc">
            ...
            <div className="filter-controls">
                ...
                <button onClick={obcFetch} disabled={loading} className="search-button filter-button">
