...
export default function Sc() {
    ...
    const scFetch = useCallback(async () => {
        setLoading(true);
        setError('');
        setResults([]);
        ...
        const requestUrl = `${API_URL}/category/sc?${queryString}`;
        try{
            ...
            console.error("Failed to fetch SC  data");
        }finally{
            setLoading(false);
        }
    ...
    return (
        <div className="Sc">
            ...
            <div className="filter-controls">
                ...
                <button onClick={scFetch} disabled={loading} className="search-button filter-button">
