...
export default function St() {
    ...
    const stFetch = useCallback(async () => {
        setLoading(true);
        setError('');
        setResults([]);
        ...
        const requestUrl = `${API_URL}/category/st?${queryString}`;
        try{
            ...
            console.error("Failed to fetch ST  data");
        }finally{
            setLoading(false);
        }
    ...
    return (
        <div className="St">
            ...
            <div className="filter-controls">
                ...
                <button onClick={stFetch} disabled={loading} className="search-button filter-button">
